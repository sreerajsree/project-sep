...
Route::get('anti-cancer-capsules', [MainController::class, 'accapsules'])->name('accapsules');
Route::get('anti-cancer-tablets', [MainController::class, 'actablets'])->name('actablets');
...
Route::get('product/{slug}', [MainController::class, 'viewProduct'])->name('view.product');
Auth::routes();
...
Route::group(['prefix' => 'dashboard', 'middleware' => 'auth'], function () {
    ...
    Route::get('products', [HomeController::class, 'products'])->name('admin.products');
    ...
    Route::get('products/create', [HomeController::class, 'productsCreate'])->name('admin.products.create');
    ...
    Route::post('products/store', [HomeController::class, 'productsStore'])->name('admin.products.create.post');
    ...
    Route::get('products/edit/{id}', [HomeController::class, 'productsEdit'])->name('admin.products.edit');
    ...
    Route::post('products/update/{id}', [HomeController::class, 'productsUpdate'])->name('admin.products.update');
    ...
    Route::get('products/delete/{id}', [HomeController::class, 'productsDelete'])->name('admin.products.delete');
