        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container-fluid">
                        <h1 class="h3 mb-2 text-gray-800">Edit: {{ $blog->name }}</h1>
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('admin.blog.update',$blog->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="mt-3">
                                        <img src="{{ asset('blog/'.$blog->image) }}" alt="{{ $blog->name }}" width="200" height="100">
                                    </div>
                                </div>
                        
                                <div class="mb-3">
                                    <label for="body" class="form-label">Body</label>
                                    <textarea class="form-control" name="body" id="body" rows="4" required>{{ $blog->body }}</textarea>
                                </div>
