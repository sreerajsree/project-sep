            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <form method="POST" action="{{ route('admin.products.create.post') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-4">
                                    <label for="category" class="form-label">Category</label>
                                    <select class="form-control" name="category" id="category" required>
                                        <option value="">Select Category</option>
                                        <option value="Anti Cancer Capsules">Anti Cancer Capsules</option>
                                        <option value="Anti Cancer Tablets">Anti Cancer Tablets</option>
                                        <option value="Pharmaceutical Injection">Pharmaceutical Injection</option>
                                    </select>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="composition" class="form-control" id="composition" placeholder="Enter Composition" required>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" name="description" id="mytextarea" rows="4" placeholder="Enter description here..." required></textarea>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" name="meta_description" id="meta_description" rows="4" placeholder="Enter Meta Description here..." required></textarea>
                                </div>
