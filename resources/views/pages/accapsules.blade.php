...
@push('seo')
    ...
    <meta name="description" content="Anti Cancer Capsules" />
@endpush
@section('content')
    <div class="top-banner">
        <img src="{{ asset('banner/products.webp') }}" class="img-fluid" alt="">
        <h1>Anti Cancer Capsules</h1>
    </div>
    <div class="container py-5">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/">Home</a></li>
                <li class="breadcrumb-item"><a href="{{ route('accapsules') }}">Anti Cancer Capsules</a></li>
            </ol>
        </nav>
        <div class="row py-4">
