    ...
    <div class="container">
        ...
        <div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <p>
                        Mankind has several areas of interest and we look forward to partners who bring in unique products,
                        services which can augment our position in the market. We are actively looking for products for
                        various geographies such as US, EM, India etc and in case you have good opportunities, please
                        contact our BD team.
                    </p>
                    <p class="mt-3">
                        If you have an opportunity that you believe would be of interest to Mankind, please contact us at
                        <a href="" class="link-primary">businessdevelopment@mankindpharma.com</a>
                    </p>
                </div>
            </div>
            ...
            <div>
                <form action="{{ route('partnership.store') }}" method="POST">
                    ...
                    <div class="form-floating mb-3">
                        <textarea class="form-control" cols="4" name="address" id="address" placeholder="Address"> </textarea>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="website" name="website" placeholder="Website Address">
                                <label for="website">Website Address</label>
                            </div>
                        </div>
                    </div>
                    <div class="form-floating mb-3">
                        <textarea class="form-control" cols="4" name="brief" id="brief" placeholder="Brief Description of Collaboration Concept"> </textarea>
                        <label for="brief">Brief Description of Collaboration Concept</label>
                    </div>
